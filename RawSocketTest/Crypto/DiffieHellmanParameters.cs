...
public class DiffieHellmanParameters
{
    ...
    private static readonly DiffieHellmanParameters[] _dhParams = {
        new()
        {
            Group = DhId.DH_1, // MODP_768_BIT
            ExponentLength = 32,
            Generator = ByteArray(0x02),
            Prime = ByteArray(
        ...
        new()
        {
            Group = DhId.DH_14, //MODP_2048_BIT,
            ExponentLength = 48,
            Generator = ByteArray(0x02),
            Prime = ByteArray(
                0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xC9, 0x0F, 0xDA, 0xA2, 0x21, 0x68, 0xC2, 0x34,
        ...
        new()
        {
            Group = DhId.DH_15, //MODP_3072_BIT,
            ExponentLength = 48,
            Generator = ByteArray(0x02),
            Prime = ByteArray(
                0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xC9, 0x0F, 0xDA, 0xA2, 0x21, 0x68, 0xC2, 0x34,
        ...
        new()
        {
            Group = DhId.DH_16, //MODP_4096_BIT,
            ExponentLength = 64,
            Generator = ByteArray(0x02),
            Prime = ByteArray(
                0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xC9, 0x0F, 0xDA, 0xA2, 0x21, 0x68, 0xC2, 0x34,
        ...
        new()
        {
            Group = DhId.DH_17,//MODP_6144_BIT,
            ExponentLength = 64,
            Generator = ByteArray(0x02),
            Prime = ByteArray(
                0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xC9, 0x0F, 0xDA, 0xA2, 0x21, 0x68, 0xC2, 0x34,
        ...
        new()
        {
            Group = DhId.DH_18,//MODP_8192_BIT,
            ExponentLength = 64,
            Generator = ByteArray(0x02),
            Prime = ByteArray(
                0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xC9, 0x0F, 0xDA, 0xA2, 0x21, 0x68, 0xC2, 0x34,
        ...
        new()
        {
            Group = DhId.DH_22,//MODP_1024_160,
            ExponentLength = 20,
            SubGroup = ByteArray(
        ...
        new()
        {
            Group = DhId.DH_23,//MODP_2048_224,
            ExponentLength = 28,
            SubGroup = ByteArray(
        ...
        new()
        {
            Group = DhId.DH_24,//MODP_2048_256,
            ExponentLength = 32,
            SubGroup = ByteArray(
    ...
    private static byte[] ByteArray(params byte[] bytes) => bytes;

    //src/libstrongswan/crypto/key_exchange.c:506
    public static DiffieHellmanParameters? GetParametersForGroup(DhId group)
        => _dhParams.FirstOrDefault(p=>p.Group == group);

    public static bool IsSupported(DhId group) => _dhParams.Any(p=>p.Group == group);
}