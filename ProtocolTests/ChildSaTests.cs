...
public class ChildSaTests
{
    ...
    public void message_round_trip()
    {
        ...
        var sender = new ChildSa(IpV4Address.Localhost, spiIn, spiOut, cryptoIn, cryptoOut, null, null, null);
        var receiver = new ChildSa(IpV4Address.Localhost,spiOut, spiIn, cryptoOut, cryptoIn, null, null, null);
    ...
    public void can_decode_ping()
    {
        ...
        var subject = new ChildSa(IpV4Address.Localhost, spiIn, spiOut, cryptoIn, cryptoOut, null, null, null);
