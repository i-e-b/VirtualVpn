...
Aug  8 14:21:58 Gertrud charon: 01[IKE]   16: 85 FE DB D6 52 1D F5 B3 BC 0E E8 4B 55 23 99 A6  ....R......KU#..
    ...
    public void decoding_encrypted_sk_payload()
    {
        ...
        // IEB: probably an error in here, as decrypted data looks very plausible
        // Remote is saying "octets = message + nonce + prf(Sk_px, IDx') => 1192 bytes", but I'm only getting 224 or so
        // Is there some fragmenting happening?
