...
*/
    ...
    public PayloadSecured(byte[] data, IkeCrypto? ikeCrypto, ref int idx, ref PayloadType nextPayload)
    {
        ...
        if (!ok) Log.Error("CHECKSUM FAILED in VirtualVpn.Payloads.PayloadSecured.PayloadSecured");
        else Log.Debug("Checksum passed in VirtualVpn.Payloads.PayloadSecured.PayloadSecured");
